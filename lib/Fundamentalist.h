...
#ifndef _LIBS_AGENT_FUNDAMENTALIST
#define _LIBS_AGENT_FUNDAMENTALIST
...
namespace AgentLib {
	...
	//! class represents a fundamentalist trader; it distringuishes itself from other traders
	//! by the way of its price formation given recent and past prices in the network.

	class Fundamentalist : public Trader {
	public:
